...
pub var imaxabs: *const fn (__n: intmax_t) callconv(.c) intmax_t = undefined;
pub var imaxdiv: *const fn (__numer: intmax_t, __denom: intmax_t) callconv(.c) imaxdiv_t = undefined;
pub var strtoimax: *const fn (noalias __nptr: [*c]const u8, noalias __endptr: [*c][*c]u8, __base: c_int) callconv(.c) intmax_t = undefined;
pub var strtoumax: *const fn (noalias __nptr: [*c]const u8, noalias __endptr: [*c][*c]u8, __base: c_int) callconv(.c) uintmax_t = undefined;
pub var wcstoimax: *const fn (noalias __nptr: [*c]const __gwchar_t, noalias __endptr: [*c][*c]__gwchar_t, __base: c_int) callconv(.c) intmax_t = undefined;
pub var wcstoumax: *const fn (noalias __nptr: [*c]const __gwchar_t, noalias __endptr: [*c][*c]__gwchar_t, __base: c_int) callconv(.c) uintmax_t = undefined;
...
pub var hb_tag_from_string: *const fn (str: [*c]const u8, len: c_int) callconv(.c) hb_tag_t = undefined;
pub var hb_tag_to_string: *const fn (tag: hb_tag_t, buf: [*c]u8) callconv(.c) void = undefined;
...
pub var hb_direction_from_string: *const fn (str: [*c]const u8, len: c_int) callconv(.c) hb_direction_t = undefined;
pub var hb_direction_to_string: *const fn (direction: hb_direction_t) callconv(.c) [*c]const u8 = undefined;
...
pub var hb_language_from_string: *const fn (str: [*c]const u8, len: c_int) callconv(.c) hb_language_t = undefined;
pub var hb_language_to_string: *const fn (language: hb_language_t) callconv(.c) [*c]const u8 = undefined;
pub var hb_language_get_default: *const fn () callconv(.c) hb_language_t = undefined;
pub var hb_language_matches: *const fn (language: hb_language_t, specific: hb_language_t) callconv(.c) hb_bool_t = undefined;
...
pub var hb_script_from_iso15924_tag: *const fn (tag: hb_tag_t) callconv(.c) hb_script_t = undefined;
pub var hb_script_from_string: *const fn (str: [*c]const u8, len: c_int) callconv(.c) hb_script_t = undefined;
pub var hb_script_to_iso15924_tag: *const fn (script: hb_script_t) callconv(.c) hb_tag_t = undefined;
pub var hb_script_get_horizontal_direction: *const fn (script: hb_script_t) callconv(.c) hb_direction_t = undefined;
...
pub var hb_feature_from_string: *const fn (str: [*c]const u8, len: c_int, feature: [*c]hb_feature_t) callconv(.c) hb_bool_t = undefined;
pub var hb_feature_to_string: *const fn (feature: [*c]hb_feature_t, buf: [*c]u8, size: c_uint) callconv(.c) void = undefined;
...
pub var hb_variation_from_string: *const fn (str: [*c]const u8, len: c_int, variation: [*c]hb_variation_t) callconv(.c) hb_bool_t = undefined;
pub var hb_variation_to_string: *const fn (variation: [*c]hb_variation_t, buf: [*c]u8, size: c_uint) callconv(.c) void = undefined;
pub const hb_color_t = u32;
pub var hb_color_get_alpha: *const fn (color: hb_color_t) callconv(.c) u8 = undefined;
pub var hb_color_get_red: *const fn (color: hb_color_t) callconv(.c) u8 = undefined;
pub var hb_color_get_green: *const fn (color: hb_color_t) callconv(.c) u8 = undefined;
pub var hb_color_get_blue: *const fn (color: hb_color_t) callconv(.c) u8 = undefined;
...
pub const struct_hb_font_t = opaque {
    ...
    pub const hb_ot_font_set_funcs = __root.hb_ot_font_set_funcs;
    ...
    pub const ot_funcs = __root.hb_ot_font_set_funcs;
...
pub var hb_malloc: *const fn (size: usize) callconv(.c) ?*anyopaque = undefined;
pub var hb_calloc: *const fn (nmemb: usize, size: usize) callconv(.c) ?*anyopaque = undefined;
pub var hb_realloc: *const fn (ptr: ?*anyopaque, size: usize) callconv(.c) ?*anyopaque = undefined;
pub var hb_free: *const fn (ptr: ?*anyopaque) callconv(.c) void = undefined;
...
pub var hb_blob_create: *const fn (data: [*c]const u8, length: c_uint, mode: hb_memory_mode_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) ?*hb_blob_t = undefined;
pub var hb_blob_create_or_fail: *const fn (data: [*c]const u8, length: c_uint, mode: hb_memory_mode_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) ?*hb_blob_t = undefined;
pub var hb_blob_create_from_file: *const fn (file_name: [*c]const u8) callconv(.c) ?*hb_blob_t = undefined;
pub var hb_blob_create_from_file_or_fail: *const fn (file_name: [*c]const u8) callconv(.c) ?*hb_blob_t = undefined;
pub var hb_blob_create_sub_blob: *const fn (parent: ?*hb_blob_t, offset: c_uint, length: c_uint) callconv(.c) ?*hb_blob_t = undefined;
pub var hb_blob_copy_writable_or_fail: *const fn (blob: ?*hb_blob_t) callconv(.c) ?*hb_blob_t = undefined;
pub var hb_blob_get_empty: *const fn () callconv(.c) ?*hb_blob_t = undefined;
pub var hb_blob_reference: *const fn (blob: ?*hb_blob_t) callconv(.c) ?*hb_blob_t = undefined;
pub var hb_blob_destroy: *const fn (blob: ?*hb_blob_t) callconv(.c) void = undefined;
pub var hb_blob_set_user_data: *const fn (blob: ?*hb_blob_t, key: [*c]hb_user_data_key_t, data: ?*anyopaque, destroy: hb_destroy_func_t, replace: hb_bool_t) callconv(.c) hb_bool_t = undefined;
pub var hb_blob_get_user_data: *const fn (blob: ?*const hb_blob_t, key: [*c]hb_user_data_key_t) callconv(.c) ?*anyopaque = undefined;
pub var hb_blob_make_immutable: *const fn (blob: ?*hb_blob_t) callconv(.c) void = undefined;
pub var hb_blob_is_immutable: *const fn (blob: ?*hb_blob_t) callconv(.c) hb_bool_t = undefined;
pub var hb_blob_get_length: *const fn (blob: ?*hb_blob_t) callconv(.c) c_uint = undefined;
pub var hb_blob_get_data: *const fn (blob: ?*hb_blob_t, length: [*c]c_uint) callconv(.c) [*c]const u8 = undefined;
pub var hb_blob_get_data_writable: *const fn (blob: ?*hb_blob_t, length: [*c]c_uint) callconv(.c) [*c]u8 = undefined;
...
pub var hb_unicode_funcs_get_default: *const fn () callconv(.c) ?*hb_unicode_funcs_t = undefined;
pub var hb_unicode_funcs_create: *const fn (parent: ?*hb_unicode_funcs_t) callconv(.c) ?*hb_unicode_funcs_t = undefined;
pub var hb_unicode_funcs_get_empty: *const fn () callconv(.c) ?*hb_unicode_funcs_t = undefined;
pub var hb_unicode_funcs_reference: *const fn (ufuncs: ?*hb_unicode_funcs_t) callconv(.c) ?*hb_unicode_funcs_t = undefined;
pub var hb_unicode_funcs_destroy: *const fn (ufuncs: ?*hb_unicode_funcs_t) callconv(.c) void = undefined;
pub var hb_unicode_funcs_set_user_data: *const fn (ufuncs: ?*hb_unicode_funcs_t, key: [*c]hb_user_data_key_t, data: ?*anyopaque, destroy: hb_destroy_func_t, replace: hb_bool_t) callconv(.c) hb_bool_t = undefined;
pub var hb_unicode_funcs_get_user_data: *const fn (ufuncs: ?*const hb_unicode_funcs_t, key: [*c]hb_user_data_key_t) callconv(.c) ?*anyopaque = undefined;
pub var hb_unicode_funcs_make_immutable: *const fn (ufuncs: ?*hb_unicode_funcs_t) callconv(.c) void = undefined;
pub var hb_unicode_funcs_is_immutable: *const fn (ufuncs: ?*hb_unicode_funcs_t) callconv(.c) hb_bool_t = undefined;
pub var hb_unicode_funcs_get_parent: *const fn (ufuncs: ?*hb_unicode_funcs_t) callconv(.c) ?*hb_unicode_funcs_t = undefined;
...
pub var hb_unicode_funcs_set_combining_class_func: *const fn (ufuncs: ?*hb_unicode_funcs_t, func: hb_unicode_combining_class_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_unicode_funcs_set_general_category_func: *const fn (ufuncs: ?*hb_unicode_funcs_t, func: hb_unicode_general_category_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_unicode_funcs_set_mirroring_func: *const fn (ufuncs: ?*hb_unicode_funcs_t, func: hb_unicode_mirroring_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_unicode_funcs_set_script_func: *const fn (ufuncs: ?*hb_unicode_funcs_t, func: hb_unicode_script_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_unicode_funcs_set_compose_func: *const fn (ufuncs: ?*hb_unicode_funcs_t, func: hb_unicode_compose_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_unicode_funcs_set_decompose_func: *const fn (ufuncs: ?*hb_unicode_funcs_t, func: hb_unicode_decompose_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_unicode_combining_class: *const fn (ufuncs: ?*hb_unicode_funcs_t, unicode: hb_codepoint_t) callconv(.c) hb_unicode_combining_class_t = undefined;
pub var hb_unicode_general_category: *const fn (ufuncs: ?*hb_unicode_funcs_t, unicode: hb_codepoint_t) callconv(.c) hb_unicode_general_category_t = undefined;
pub var hb_unicode_mirroring: *const fn (ufuncs: ?*hb_unicode_funcs_t, unicode: hb_codepoint_t) callconv(.c) hb_codepoint_t = undefined;
pub var hb_unicode_script: *const fn (ufuncs: ?*hb_unicode_funcs_t, unicode: hb_codepoint_t) callconv(.c) hb_script_t = undefined;
pub var hb_unicode_compose: *const fn (ufuncs: ?*hb_unicode_funcs_t, a: hb_codepoint_t, b: hb_codepoint_t, ab: [*c]hb_codepoint_t) callconv(.c) hb_bool_t = undefined;
pub var hb_unicode_decompose: *const fn (ufuncs: ?*hb_unicode_funcs_t, ab: hb_codepoint_t, a: [*c]hb_codepoint_t, b: [*c]hb_codepoint_t) callconv(.c) hb_bool_t = undefined;
...
pub var hb_set_create: *const fn () callconv(.c) ?*hb_set_t = undefined;
pub var hb_set_get_empty: *const fn () callconv(.c) ?*hb_set_t = undefined;
pub var hb_set_reference: *const fn (set: ?*hb_set_t) callconv(.c) ?*hb_set_t = undefined;
pub var hb_set_destroy: *const fn (set: ?*hb_set_t) callconv(.c) void = undefined;
pub var hb_set_set_user_data: *const fn (set: ?*hb_set_t, key: [*c]hb_user_data_key_t, data: ?*anyopaque, destroy: hb_destroy_func_t, replace: hb_bool_t) callconv(.c) hb_bool_t = undefined;
pub var hb_set_get_user_data: *const fn (set: ?*const hb_set_t, key: [*c]hb_user_data_key_t) callconv(.c) ?*anyopaque = undefined;
pub var hb_set_allocation_successful: *const fn (set: ?*const hb_set_t) callconv(.c) hb_bool_t = undefined;
pub var hb_set_copy: *const fn (set: ?*const hb_set_t) callconv(.c) ?*hb_set_t = undefined;
pub var hb_set_clear: *const fn (set: ?*hb_set_t) callconv(.c) void = undefined;
pub var hb_set_is_empty: *const fn (set: ?*const hb_set_t) callconv(.c) hb_bool_t = undefined;
pub var hb_set_invert: *const fn (set: ?*hb_set_t) callconv(.c) void = undefined;
pub var hb_set_is_inverted: *const fn (set: ?*const hb_set_t) callconv(.c) hb_bool_t = undefined;
pub var hb_set_has: *const fn (set: ?*const hb_set_t, codepoint: hb_codepoint_t) callconv(.c) hb_bool_t = undefined;
pub var hb_set_add: *const fn (set: ?*hb_set_t, codepoint: hb_codepoint_t) callconv(.c) void = undefined;
pub var hb_set_add_range: *const fn (set: ?*hb_set_t, first: hb_codepoint_t, last: hb_codepoint_t) callconv(.c) void = undefined;
pub var hb_set_add_sorted_array: *const fn (set: ?*hb_set_t, sorted_codepoints: [*c]const hb_codepoint_t, num_codepoints: c_uint) callconv(.c) void = undefined;
pub var hb_set_del: *const fn (set: ?*hb_set_t, codepoint: hb_codepoint_t) callconv(.c) void = undefined;
pub var hb_set_del_range: *const fn (set: ?*hb_set_t, first: hb_codepoint_t, last: hb_codepoint_t) callconv(.c) void = undefined;
pub var hb_set_is_equal: *const fn (set: ?*const hb_set_t, other: ?*const hb_set_t) callconv(.c) hb_bool_t = undefined;
pub var hb_set_hash: *const fn (set: ?*const hb_set_t) callconv(.c) c_uint = undefined;
pub var hb_set_is_subset: *const fn (set: ?*const hb_set_t, larger_set: ?*const hb_set_t) callconv(.c) hb_bool_t = undefined;
pub var hb_set_set: *const fn (set: ?*hb_set_t, other: ?*const hb_set_t) callconv(.c) void = undefined;
pub var hb_set_union: *const fn (set: ?*hb_set_t, other: ?*const hb_set_t) callconv(.c) void = undefined;
pub var hb_set_intersect: *const fn (set: ?*hb_set_t, other: ?*const hb_set_t) callconv(.c) void = undefined;
pub var hb_set_subtract: *const fn (set: ?*hb_set_t, other: ?*const hb_set_t) callconv(.c) void = undefined;
pub var hb_set_symmetric_difference: *const fn (set: ?*hb_set_t, other: ?*const hb_set_t) callconv(.c) void = undefined;
pub var hb_set_get_population: *const fn (set: ?*const hb_set_t) callconv(.c) c_uint = undefined;
pub var hb_set_get_min: *const fn (set: ?*const hb_set_t) callconv(.c) hb_codepoint_t = undefined;
pub var hb_set_get_max: *const fn (set: ?*const hb_set_t) callconv(.c) hb_codepoint_t = undefined;
pub var hb_set_next: *const fn (set: ?*const hb_set_t, codepoint: [*c]hb_codepoint_t) callconv(.c) hb_bool_t = undefined;
pub var hb_set_previous: *const fn (set: ?*const hb_set_t, codepoint: [*c]hb_codepoint_t) callconv(.c) hb_bool_t = undefined;
pub var hb_set_next_range: *const fn (set: ?*const hb_set_t, first: [*c]hb_codepoint_t, last: [*c]hb_codepoint_t) callconv(.c) hb_bool_t = undefined;
pub var hb_set_previous_range: *const fn (set: ?*const hb_set_t, first: [*c]hb_codepoint_t, last: [*c]hb_codepoint_t) callconv(.c) hb_bool_t = undefined;
pub var hb_set_next_many: *const fn (set: ?*const hb_set_t, codepoint: hb_codepoint_t, out: [*c]hb_codepoint_t, size: c_uint) callconv(.c) c_uint = undefined;
...
pub var hb_map_create: *const fn () callconv(.c) ?*hb_map_t = undefined;
pub var hb_map_get_empty: *const fn () callconv(.c) ?*hb_map_t = undefined;
pub var hb_map_reference: *const fn (map: ?*hb_map_t) callconv(.c) ?*hb_map_t = undefined;
pub var hb_map_destroy: *const fn (map: ?*hb_map_t) callconv(.c) void = undefined;
pub var hb_map_set_user_data: *const fn (map: ?*hb_map_t, key: [*c]hb_user_data_key_t, data: ?*anyopaque, destroy: hb_destroy_func_t, replace: hb_bool_t) callconv(.c) hb_bool_t = undefined;
pub var hb_map_get_user_data: *const fn (map: ?*const hb_map_t, key: [*c]hb_user_data_key_t) callconv(.c) ?*anyopaque = undefined;
pub var hb_map_allocation_successful: *const fn (map: ?*const hb_map_t) callconv(.c) hb_bool_t = undefined;
pub var hb_map_copy: *const fn (map: ?*const hb_map_t) callconv(.c) ?*hb_map_t = undefined;
pub var hb_map_clear: *const fn (map: ?*hb_map_t) callconv(.c) void = undefined;
pub var hb_map_is_empty: *const fn (map: ?*const hb_map_t) callconv(.c) hb_bool_t = undefined;
pub var hb_map_get_population: *const fn (map: ?*const hb_map_t) callconv(.c) c_uint = undefined;
pub var hb_map_is_equal: *const fn (map: ?*const hb_map_t, other: ?*const hb_map_t) callconv(.c) hb_bool_t = undefined;
pub var hb_map_hash: *const fn (map: ?*const hb_map_t) callconv(.c) c_uint = undefined;
pub var hb_map_set: *const fn (map: ?*hb_map_t, key: hb_codepoint_t, value: hb_codepoint_t) callconv(.c) void = undefined;
pub var hb_map_get: *const fn (map: ?*const hb_map_t, key: hb_codepoint_t) callconv(.c) hb_codepoint_t = undefined;
pub var hb_map_del: *const fn (map: ?*hb_map_t, key: hb_codepoint_t) callconv(.c) void = undefined;
pub var hb_map_has: *const fn (map: ?*const hb_map_t, key: hb_codepoint_t) callconv(.c) hb_bool_t = undefined;
pub var hb_map_update: *const fn (map: ?*hb_map_t, other: ?*const hb_map_t) callconv(.c) void = undefined;
pub var hb_map_next: *const fn (map: ?*const hb_map_t, idx: [*c]c_int, key: [*c]hb_codepoint_t, value: [*c]hb_codepoint_t) callconv(.c) hb_bool_t = undefined;
pub var hb_map_keys: *const fn (map: ?*const hb_map_t, keys: ?*hb_set_t) callconv(.c) void = undefined;
pub var hb_map_values: *const fn (map: ?*const hb_map_t, values: ?*hb_set_t) callconv(.c) void = undefined;
pub var hb_face_count: *const fn (blob: ?*hb_blob_t) callconv(.c) c_uint = undefined;
...
pub var hb_face_create: *const fn (blob: ?*hb_blob_t, index: c_uint) callconv(.c) ?*hb_face_t = undefined;
pub var hb_face_create_or_fail: *const fn (blob: ?*hb_blob_t, index: c_uint) callconv(.c) ?*hb_face_t = undefined;
pub var hb_face_create_or_fail_using: *const fn (blob: ?*hb_blob_t, index: c_uint, loader_name: [*c]const u8) callconv(.c) ?*hb_face_t = undefined;
pub var hb_face_create_from_file_or_fail: *const fn (file_name: [*c]const u8, index: c_uint) callconv(.c) ?*hb_face_t = undefined;
pub var hb_face_create_from_file_or_fail_using: *const fn (file_name: [*c]const u8, index: c_uint, loader_name: [*c]const u8) callconv(.c) ?*hb_face_t = undefined;
pub var hb_face_list_loaders: *const fn () callconv(.c) [*c][*c]const u8 = undefined;
pub const hb_reference_table_func_t = ?*const fn (face: ?*hb_face_t, tag: hb_tag_t, user_data: ?*anyopaque) callconv(.c) ?*hb_blob_t;
pub var hb_face_create_for_tables: *const fn (reference_table_func: hb_reference_table_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) ?*hb_face_t = undefined;
pub var hb_face_get_empty: *const fn () callconv(.c) ?*hb_face_t = undefined;
pub var hb_face_reference: *const fn (face: ?*hb_face_t) callconv(.c) ?*hb_face_t = undefined;
pub var hb_face_destroy: *const fn (face: ?*hb_face_t) callconv(.c) void = undefined;
pub var hb_face_set_user_data: *const fn (face: ?*hb_face_t, key: [*c]hb_user_data_key_t, data: ?*anyopaque, destroy: hb_destroy_func_t, replace: hb_bool_t) callconv(.c) hb_bool_t = undefined;
pub var hb_face_get_user_data: *const fn (face: ?*const hb_face_t, key: [*c]hb_user_data_key_t) callconv(.c) ?*anyopaque = undefined;
pub var hb_face_make_immutable: *const fn (face: ?*hb_face_t) callconv(.c) void = undefined;
pub var hb_face_is_immutable: *const fn (face: ?*hb_face_t) callconv(.c) hb_bool_t = undefined;
pub var hb_face_reference_table: *const fn (face: ?*const hb_face_t, tag: hb_tag_t) callconv(.c) ?*hb_blob_t = undefined;
pub var hb_face_reference_blob: *const fn (face: ?*hb_face_t) callconv(.c) ?*hb_blob_t = undefined;
pub var hb_face_set_index: *const fn (face: ?*hb_face_t, index: c_uint) callconv(.c) void = undefined;
pub var hb_face_get_index: *const fn (face: ?*const hb_face_t) callconv(.c) c_uint = undefined;
pub var hb_face_set_upem: *const fn (face: ?*hb_face_t, upem: c_uint) callconv(.c) void = undefined;
pub var hb_face_get_upem: *const fn (face: ?*const hb_face_t) callconv(.c) c_uint = undefined;
pub var hb_face_set_glyph_count: *const fn (face: ?*hb_face_t, glyph_count: c_uint) callconv(.c) void = undefined;
pub var hb_face_get_glyph_count: *const fn (face: ?*const hb_face_t) callconv(.c) c_uint = undefined;
...
pub var hb_face_set_get_table_tags_func: *const fn (face: ?*hb_face_t, func: hb_get_table_tags_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_face_get_table_tags: *const fn (face: ?*const hb_face_t, start_offset: c_uint, table_count: [*c]c_uint, table_tags: [*c]hb_tag_t) callconv(.c) c_uint = undefined;
pub var hb_face_collect_unicodes: *const fn (face: ?*hb_face_t, out: ?*hb_set_t) callconv(.c) void = undefined;
pub var hb_face_collect_nominal_glyph_mapping: *const fn (face: ?*hb_face_t, mapping: ?*hb_map_t, unicodes: ?*hb_set_t) callconv(.c) void = undefined;
pub var hb_face_collect_variation_selectors: *const fn (face: ?*hb_face_t, out: ?*hb_set_t) callconv(.c) void = undefined;
pub var hb_face_collect_variation_unicodes: *const fn (face: ?*hb_face_t, variation_selector: hb_codepoint_t, out: ?*hb_set_t) callconv(.c) void = undefined;
pub var hb_face_builder_create: *const fn () callconv(.c) ?*hb_face_t = undefined;
pub var hb_face_builder_add_table: *const fn (face: ?*hb_face_t, tag: hb_tag_t, blob: ?*hb_blob_t) callconv(.c) hb_bool_t = undefined;
pub var hb_face_builder_sort_tables: *const fn (face: ?*hb_face_t, tags: [*c]const hb_tag_t) callconv(.c) void = undefined;
...
pub var hb_draw_funcs_set_move_to_func: *const fn (dfuncs: ?*hb_draw_funcs_t, func: hb_draw_move_to_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_draw_funcs_set_line_to_func: *const fn (dfuncs: ?*hb_draw_funcs_t, func: hb_draw_line_to_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_draw_funcs_set_quadratic_to_func: *const fn (dfuncs: ?*hb_draw_funcs_t, func: hb_draw_quadratic_to_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_draw_funcs_set_cubic_to_func: *const fn (dfuncs: ?*hb_draw_funcs_t, func: hb_draw_cubic_to_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_draw_funcs_set_close_path_func: *const fn (dfuncs: ?*hb_draw_funcs_t, func: hb_draw_close_path_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_draw_funcs_create: *const fn () callconv(.c) ?*hb_draw_funcs_t = undefined;
pub var hb_draw_funcs_get_empty: *const fn () callconv(.c) ?*hb_draw_funcs_t = undefined;
pub var hb_draw_funcs_reference: *const fn (dfuncs: ?*hb_draw_funcs_t) callconv(.c) ?*hb_draw_funcs_t = undefined;
pub var hb_draw_funcs_destroy: *const fn (dfuncs: ?*hb_draw_funcs_t) callconv(.c) void = undefined;
pub var hb_draw_funcs_set_user_data: *const fn (dfuncs: ?*hb_draw_funcs_t, key: [*c]hb_user_data_key_t, data: ?*anyopaque, destroy: hb_destroy_func_t, replace: hb_bool_t) callconv(.c) hb_bool_t = undefined;
pub var hb_draw_funcs_get_user_data: *const fn (dfuncs: ?*const hb_draw_funcs_t, key: [*c]hb_user_data_key_t) callconv(.c) ?*anyopaque = undefined;
pub var hb_draw_funcs_make_immutable: *const fn (dfuncs: ?*hb_draw_funcs_t) callconv(.c) void = undefined;
pub var hb_draw_funcs_is_immutable: *const fn (dfuncs: ?*hb_draw_funcs_t) callconv(.c) hb_bool_t = undefined;
pub var hb_draw_move_to: *const fn (dfuncs: ?*hb_draw_funcs_t, draw_data: ?*anyopaque, st: [*c]hb_draw_state_t, to_x: f32, to_y: f32) callconv(.c) void = undefined;
pub var hb_draw_line_to: *const fn (dfuncs: ?*hb_draw_funcs_t, draw_data: ?*anyopaque, st: [*c]hb_draw_state_t, to_x: f32, to_y: f32) callconv(.c) void = undefined;
pub var hb_draw_quadratic_to: *const fn (dfuncs: ?*hb_draw_funcs_t, draw_data: ?*anyopaque, st: [*c]hb_draw_state_t, control_x: f32, control_y: f32, to_x: f32, to_y: f32) callconv(.c) void = undefined;
pub var hb_draw_cubic_to: *const fn (dfuncs: ?*hb_draw_funcs_t, draw_data: ?*anyopaque, st: [*c]hb_draw_state_t, control1_x: f32, control1_y: f32, control2_x: f32, control2_y: f32, to_x: f32, to_y: f32) callconv(.c) void = undefined;
pub var hb_draw_close_path: *const fn (dfuncs: ?*hb_draw_funcs_t, draw_data: ?*anyopaque, st: [*c]hb_draw_state_t) callconv(.c) void = undefined;
...
pub var hb_paint_funcs_create: *const fn () callconv(.c) ?*hb_paint_funcs_t = undefined;
pub var hb_paint_funcs_get_empty: *const fn () callconv(.c) ?*hb_paint_funcs_t = undefined;
pub var hb_paint_funcs_reference: *const fn (funcs: ?*hb_paint_funcs_t) callconv(.c) ?*hb_paint_funcs_t = undefined;
pub var hb_paint_funcs_destroy: *const fn (funcs: ?*hb_paint_funcs_t) callconv(.c) void = undefined;
pub var hb_paint_funcs_set_user_data: *const fn (funcs: ?*hb_paint_funcs_t, key: [*c]hb_user_data_key_t, data: ?*anyopaque, destroy: hb_destroy_func_t, replace: hb_bool_t) callconv(.c) hb_bool_t = undefined;
pub var hb_paint_funcs_get_user_data: *const fn (funcs: ?*const hb_paint_funcs_t, key: [*c]hb_user_data_key_t) callconv(.c) ?*anyopaque = undefined;
pub var hb_paint_funcs_make_immutable: *const fn (funcs: ?*hb_paint_funcs_t) callconv(.c) void = undefined;
pub var hb_paint_funcs_is_immutable: *const fn (funcs: ?*hb_paint_funcs_t) callconv(.c) hb_bool_t = undefined;
...
pub var hb_color_line_get_color_stops: *const fn (color_line: [*c]hb_color_line_t, start: c_uint, count: [*c]c_uint, color_stops: [*c]hb_color_stop_t) callconv(.c) c_uint = undefined;
pub var hb_color_line_get_extend: *const fn (color_line: [*c]hb_color_line_t) callconv(.c) hb_paint_extend_t = undefined;
...
pub var hb_paint_funcs_set_push_transform_func: *const fn (funcs: ?*hb_paint_funcs_t, func: hb_paint_push_transform_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_paint_funcs_set_pop_transform_func: *const fn (funcs: ?*hb_paint_funcs_t, func: hb_paint_pop_transform_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_paint_funcs_set_color_glyph_func: *const fn (funcs: ?*hb_paint_funcs_t, func: hb_paint_color_glyph_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_paint_funcs_set_push_clip_glyph_func: *const fn (funcs: ?*hb_paint_funcs_t, func: hb_paint_push_clip_glyph_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_paint_funcs_set_push_clip_rectangle_func: *const fn (funcs: ?*hb_paint_funcs_t, func: hb_paint_push_clip_rectangle_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_paint_funcs_set_pop_clip_func: *const fn (funcs: ?*hb_paint_funcs_t, func: hb_paint_pop_clip_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_paint_funcs_set_color_func: *const fn (funcs: ?*hb_paint_funcs_t, func: hb_paint_color_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_paint_funcs_set_image_func: *const fn (funcs: ?*hb_paint_funcs_t, func: hb_paint_image_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_paint_funcs_set_linear_gradient_func: *const fn (funcs: ?*hb_paint_funcs_t, func: hb_paint_linear_gradient_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_paint_funcs_set_radial_gradient_func: *const fn (funcs: ?*hb_paint_funcs_t, func: hb_paint_radial_gradient_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_paint_funcs_set_sweep_gradient_func: *const fn (funcs: ?*hb_paint_funcs_t, func: hb_paint_sweep_gradient_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_paint_funcs_set_push_group_func: *const fn (funcs: ?*hb_paint_funcs_t, func: hb_paint_push_group_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_paint_funcs_set_pop_group_func: *const fn (funcs: ?*hb_paint_funcs_t, func: hb_paint_pop_group_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_paint_funcs_set_custom_palette_color_func: *const fn (funcs: ?*hb_paint_funcs_t, func: hb_paint_custom_palette_color_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_paint_push_transform: *const fn (funcs: ?*hb_paint_funcs_t, paint_data: ?*anyopaque, xx: f32, yx: f32, xy: f32, yy: f32, dx: f32, dy: f32) callconv(.c) void = undefined;
pub var hb_paint_push_font_transform: *const fn (funcs: ?*hb_paint_funcs_t, paint_data: ?*anyopaque, font: ?*const hb_font_t) callconv(.c) void = undefined;
pub var hb_paint_push_inverse_font_transform: *const fn (funcs: ?*hb_paint_funcs_t, paint_data: ?*anyopaque, font: ?*const hb_font_t) callconv(.c) void = undefined;
pub var hb_paint_pop_transform: *const fn (funcs: ?*hb_paint_funcs_t, paint_data: ?*anyopaque) callconv(.c) void = undefined;
pub var hb_paint_color_glyph: *const fn (funcs: ?*hb_paint_funcs_t, paint_data: ?*anyopaque, glyph: hb_codepoint_t, font: ?*hb_font_t) callconv(.c) hb_bool_t = undefined;
pub var hb_paint_push_clip_glyph: *const fn (funcs: ?*hb_paint_funcs_t, paint_data: ?*anyopaque, glyph: hb_codepoint_t, font: ?*hb_font_t) callconv(.c) void = undefined;
pub var hb_paint_push_clip_rectangle: *const fn (funcs: ?*hb_paint_funcs_t, paint_data: ?*anyopaque, xmin: f32, ymin: f32, xmax: f32, ymax: f32) callconv(.c) void = undefined;
pub var hb_paint_pop_clip: *const fn (funcs: ?*hb_paint_funcs_t, paint_data: ?*anyopaque) callconv(.c) void = undefined;
pub var hb_paint_color: *const fn (funcs: ?*hb_paint_funcs_t, paint_data: ?*anyopaque, is_foreground: hb_bool_t, color: hb_color_t) callconv(.c) void = undefined;
pub var hb_paint_image: *const fn (funcs: ?*hb_paint_funcs_t, paint_data: ?*anyopaque, image: ?*hb_blob_t, width: c_uint, height: c_uint, format: hb_tag_t, slant: f32, extents: [*c]hb_glyph_extents_t) callconv(.c) void = undefined;
pub var hb_paint_linear_gradient: *const fn (funcs: ?*hb_paint_funcs_t, paint_data: ?*anyopaque, color_line: [*c]hb_color_line_t, x0: f32, y0: f32, x1: f32, y1: f32, x2: f32, y2: f32) callconv(.c) void = undefined;
pub var hb_paint_radial_gradient: *const fn (funcs: ?*hb_paint_funcs_t, paint_data: ?*anyopaque, color_line: [*c]hb_color_line_t, x0: f32, y0: f32, r0: f32, x1: f32, y1: f32, r1: f32) callconv(.c) void = undefined;
pub var hb_paint_sweep_gradient: *const fn (funcs: ?*hb_paint_funcs_t, paint_data: ?*anyopaque, color_line: [*c]hb_color_line_t, x0: f32, y0: f32, start_angle: f32, end_angle: f32) callconv(.c) void = undefined;
pub var hb_paint_push_group: *const fn (funcs: ?*hb_paint_funcs_t, paint_data: ?*anyopaque) callconv(.c) void = undefined;
pub var hb_paint_pop_group: *const fn (funcs: ?*hb_paint_funcs_t, paint_data: ?*anyopaque, mode: hb_paint_composite_mode_t) callconv(.c) void = undefined;
pub var hb_paint_custom_palette_color: *const fn (funcs: ?*hb_paint_funcs_t, paint_data: ?*anyopaque, color_index: c_uint, color: [*c]hb_color_t) callconv(.c) hb_bool_t = undefined;
...
pub var hb_font_funcs_create: *const fn () callconv(.c) ?*hb_font_funcs_t = undefined;
pub var hb_font_funcs_get_empty: *const fn () callconv(.c) ?*hb_font_funcs_t = undefined;
pub var hb_font_funcs_reference: *const fn (ffuncs: ?*hb_font_funcs_t) callconv(.c) ?*hb_font_funcs_t = undefined;
pub var hb_font_funcs_destroy: *const fn (ffuncs: ?*hb_font_funcs_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_user_data: *const fn (ffuncs: ?*hb_font_funcs_t, key: [*c]hb_user_data_key_t, data: ?*anyopaque, destroy: hb_destroy_func_t, replace: hb_bool_t) callconv(.c) hb_bool_t = undefined;
pub var hb_font_funcs_get_user_data: *const fn (ffuncs: ?*const hb_font_funcs_t, key: [*c]hb_user_data_key_t) callconv(.c) ?*anyopaque = undefined;
pub var hb_font_funcs_make_immutable: *const fn (ffuncs: ?*hb_font_funcs_t) callconv(.c) void = undefined;
pub var hb_font_funcs_is_immutable: *const fn (ffuncs: ?*hb_font_funcs_t) callconv(.c) hb_bool_t = undefined;
...
pub var hb_font_funcs_set_font_h_extents_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_font_h_extents_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_font_v_extents_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_font_v_extents_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_nominal_glyph_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_nominal_glyph_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_nominal_glyphs_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_nominal_glyphs_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_variation_glyph_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_variation_glyph_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_glyph_h_advance_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_glyph_h_advance_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_glyph_v_advance_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_glyph_v_advance_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_glyph_h_advances_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_glyph_h_advances_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_glyph_v_advances_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_glyph_v_advances_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_glyph_h_origin_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_glyph_h_origin_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_glyph_v_origin_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_glyph_v_origin_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_glyph_h_origins_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_glyph_h_origins_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_glyph_v_origins_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_glyph_v_origins_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_glyph_h_kerning_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_glyph_h_kerning_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_glyph_extents_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_glyph_extents_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_glyph_contour_point_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_glyph_contour_point_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_glyph_name_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_glyph_name_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_glyph_from_name_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_glyph_from_name_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_draw_glyph_or_fail_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_draw_glyph_or_fail_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_paint_glyph_or_fail_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_paint_glyph_or_fail_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_get_h_extents: *const fn (font: ?*hb_font_t, extents: [*c]hb_font_extents_t) callconv(.c) hb_bool_t = undefined;
pub var hb_font_get_v_extents: *const fn (font: ?*hb_font_t, extents: [*c]hb_font_extents_t) callconv(.c) hb_bool_t = undefined;
pub var hb_font_get_nominal_glyph: *const fn (font: ?*hb_font_t, unicode: hb_codepoint_t, glyph: [*c]hb_codepoint_t) callconv(.c) hb_bool_t = undefined;
pub var hb_font_get_variation_glyph: *const fn (font: ?*hb_font_t, unicode: hb_codepoint_t, variation_selector: hb_codepoint_t, glyph: [*c]hb_codepoint_t) callconv(.c) hb_bool_t = undefined;
pub var hb_font_get_nominal_glyphs: *const fn (font: ?*hb_font_t, count: c_uint, first_unicode: [*c]const hb_codepoint_t, unicode_stride: c_uint, first_glyph: [*c]hb_codepoint_t, glyph_stride: c_uint) callconv(.c) c_uint = undefined;
pub var hb_font_get_glyph_h_advance: *const fn (font: ?*hb_font_t, glyph: hb_codepoint_t) callconv(.c) hb_position_t = undefined;
pub var hb_font_get_glyph_v_advance: *const fn (font: ?*hb_font_t, glyph: hb_codepoint_t) callconv(.c) hb_position_t = undefined;
pub var hb_font_get_glyph_h_advances: *const fn (font: ?*hb_font_t, count: c_uint, first_glyph: [*c]const hb_codepoint_t, glyph_stride: c_uint, first_advance: [*c]hb_position_t, advance_stride: c_uint) callconv(.c) void = undefined;
pub var hb_font_get_glyph_v_advances: *const fn (font: ?*hb_font_t, count: c_uint, first_glyph: [*c]const hb_codepoint_t, glyph_stride: c_uint, first_advance: [*c]hb_position_t, advance_stride: c_uint) callconv(.c) void = undefined;
pub var hb_font_get_glyph_h_origin: *const fn (font: ?*hb_font_t, glyph: hb_codepoint_t, x: [*c]hb_position_t, y: [*c]hb_position_t) callconv(.c) hb_bool_t = undefined;
pub var hb_font_get_glyph_v_origin: *const fn (font: ?*hb_font_t, glyph: hb_codepoint_t, x: [*c]hb_position_t, y: [*c]hb_position_t) callconv(.c) hb_bool_t = undefined;
pub var hb_font_get_glyph_h_origins: *const fn (font: ?*hb_font_t, count: c_uint, first_glyph: [*c]const hb_codepoint_t, glyph_stride: c_uint, first_x: [*c]hb_position_t, x_stride: c_uint, first_y: [*c]hb_position_t, y_stride: c_uint) callconv(.c) hb_bool_t = undefined;
pub var hb_font_get_glyph_v_origins: *const fn (font: ?*hb_font_t, count: c_uint, first_glyph: [*c]const hb_codepoint_t, glyph_stride: c_uint, first_x: [*c]hb_position_t, x_stride: c_uint, first_y: [*c]hb_position_t, y_stride: c_uint) callconv(.c) hb_bool_t = undefined;
pub var hb_font_get_glyph_h_kerning: *const fn (font: ?*hb_font_t, left_glyph: hb_codepoint_t, right_glyph: hb_codepoint_t) callconv(.c) hb_position_t = undefined;
pub var hb_font_get_glyph_extents: *const fn (font: ?*hb_font_t, glyph: hb_codepoint_t, extents: [*c]hb_glyph_extents_t) callconv(.c) hb_bool_t = undefined;
pub var hb_font_get_glyph_contour_point: *const fn (font: ?*hb_font_t, glyph: hb_codepoint_t, point_index: c_uint, x: [*c]hb_position_t, y: [*c]hb_position_t) callconv(.c) hb_bool_t = undefined;
pub var hb_font_get_glyph_name: *const fn (font: ?*hb_font_t, glyph: hb_codepoint_t, name: [*c]u8, size: c_uint) callconv(.c) hb_bool_t = undefined;
pub var hb_font_get_glyph_from_name: *const fn (font: ?*hb_font_t, name: [*c]const u8, len: c_int, glyph: [*c]hb_codepoint_t) callconv(.c) hb_bool_t = undefined;
pub var hb_font_draw_glyph_or_fail: *const fn (font: ?*hb_font_t, glyph: hb_codepoint_t, dfuncs: ?*hb_draw_funcs_t, draw_data: ?*anyopaque) callconv(.c) hb_bool_t = undefined;
pub var hb_font_paint_glyph_or_fail: *const fn (font: ?*hb_font_t, glyph: hb_codepoint_t, pfuncs: ?*hb_paint_funcs_t, paint_data: ?*anyopaque, palette_index: c_uint, foreground: hb_color_t) callconv(.c) hb_bool_t = undefined;
pub var hb_font_get_glyph: *const fn (font: ?*hb_font_t, unicode: hb_codepoint_t, variation_selector: hb_codepoint_t, glyph: [*c]hb_codepoint_t) callconv(.c) hb_bool_t = undefined;
pub var hb_font_get_extents_for_direction: *const fn (font: ?*hb_font_t, direction: hb_direction_t, extents: [*c]hb_font_extents_t) callconv(.c) void = undefined;
pub var hb_font_get_glyph_advance_for_direction: *const fn (font: ?*hb_font_t, glyph: hb_codepoint_t, direction: hb_direction_t, x: [*c]hb_position_t, y: [*c]hb_position_t) callconv(.c) void = undefined;
pub var hb_font_get_glyph_advances_for_direction: *const fn (font: ?*hb_font_t, direction: hb_direction_t, count: c_uint, first_glyph: [*c]const hb_codepoint_t, glyph_stride: c_uint, first_advance: [*c]hb_position_t, advance_stride: c_uint) callconv(.c) void = undefined;
pub var hb_font_get_glyph_origin_for_direction: *const fn (font: ?*hb_font_t, glyph: hb_codepoint_t, direction: hb_direction_t, x: [*c]hb_position_t, y: [*c]hb_position_t) callconv(.c) void = undefined;
pub var hb_font_add_glyph_origin_for_direction: *const fn (font: ?*hb_font_t, glyph: hb_codepoint_t, direction: hb_direction_t, x: [*c]hb_position_t, y: [*c]hb_position_t) callconv(.c) void = undefined;
pub var hb_font_subtract_glyph_origin_for_direction: *const fn (font: ?*hb_font_t, glyph: hb_codepoint_t, direction: hb_direction_t, x: [*c]hb_position_t, y: [*c]hb_position_t) callconv(.c) void = undefined;
pub var hb_font_get_glyph_kerning_for_direction: *const fn (font: ?*hb_font_t, first_glyph: hb_codepoint_t, second_glyph: hb_codepoint_t, direction: hb_direction_t, x: [*c]hb_position_t, y: [*c]hb_position_t) callconv(.c) void = undefined;
pub var hb_font_get_glyph_extents_for_origin: *const fn (font: ?*hb_font_t, glyph: hb_codepoint_t, direction: hb_direction_t, extents: [*c]hb_glyph_extents_t) callconv(.c) hb_bool_t = undefined;
pub var hb_font_get_glyph_contour_point_for_origin: *const fn (font: ?*hb_font_t, glyph: hb_codepoint_t, point_index: c_uint, direction: hb_direction_t, x: [*c]hb_position_t, y: [*c]hb_position_t) callconv(.c) hb_bool_t = undefined;
pub var hb_font_glyph_to_string: *const fn (font: ?*hb_font_t, glyph: hb_codepoint_t, s: [*c]u8, size: c_uint) callconv(.c) void = undefined;
pub var hb_font_glyph_from_string: *const fn (font: ?*hb_font_t, s: [*c]const u8, len: c_int, glyph: [*c]hb_codepoint_t) callconv(.c) hb_bool_t = undefined;
pub var hb_font_draw_glyph: *const fn (font: ?*hb_font_t, glyph: hb_codepoint_t, dfuncs: ?*hb_draw_funcs_t, draw_data: ?*anyopaque) callconv(.c) void = undefined;
pub var hb_font_paint_glyph: *const fn (font: ?*hb_font_t, glyph: hb_codepoint_t, pfuncs: ?*hb_paint_funcs_t, paint_data: ?*anyopaque, palette_index: c_uint, foreground: hb_color_t) callconv(.c) void = undefined;
pub var hb_font_create: *const fn (face: ?*hb_face_t) callconv(.c) ?*hb_font_t = undefined;
pub var hb_font_create_sub_font: *const fn (parent: ?*hb_font_t) callconv(.c) ?*hb_font_t = undefined;
pub var hb_font_get_empty: *const fn () callconv(.c) ?*hb_font_t = undefined;
pub var hb_font_reference: *const fn (font: ?*hb_font_t) callconv(.c) ?*hb_font_t = undefined;
pub var hb_font_destroy: *const fn (font: ?*hb_font_t) callconv(.c) void = undefined;
pub var hb_font_set_user_data: *const fn (font: ?*hb_font_t, key: [*c]hb_user_data_key_t, data: ?*anyopaque, destroy: hb_destroy_func_t, replace: hb_bool_t) callconv(.c) hb_bool_t = undefined;
pub var hb_font_get_user_data: *const fn (font: ?*const hb_font_t, key: [*c]hb_user_data_key_t) callconv(.c) ?*anyopaque = undefined;
pub var hb_font_make_immutable: *const fn (font: ?*hb_font_t) callconv(.c) void = undefined;
pub var hb_font_is_immutable: *const fn (font: ?*hb_font_t) callconv(.c) hb_bool_t = undefined;
pub var hb_font_get_serial: *const fn (font: ?*hb_font_t) callconv(.c) c_uint = undefined;
pub var hb_font_changed: *const fn (font: ?*hb_font_t) callconv(.c) void = undefined;
pub var hb_font_set_parent: *const fn (font: ?*hb_font_t, parent: ?*hb_font_t) callconv(.c) void = undefined;
pub var hb_font_get_parent: *const fn (font: ?*hb_font_t) callconv(.c) ?*hb_font_t = undefined;
pub var hb_font_set_face: *const fn (font: ?*hb_font_t, face: ?*hb_face_t) callconv(.c) void = undefined;
pub var hb_font_get_face: *const fn (font: ?*hb_font_t) callconv(.c) ?*hb_face_t = undefined;
pub var hb_font_set_funcs: *const fn (font: ?*hb_font_t, klass: ?*hb_font_funcs_t, font_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_set_funcs_data: *const fn (font: ?*hb_font_t, font_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
// Local addition: `hb-ot-font.h` is not part of the translated header set.
// Older system HarfBuzz (e.g. 8.x) has no name-based `hb_font_set_funcs_using`;
// `hb_ot_font_set_funcs` is the stable API that installs the OpenType font
// functions on a face-backed `hb_font_t`.
pub var hb_ot_font_set_funcs: *const fn (font: ?*hb_font_t) callconv(.c) void = undefined;
pub var hb_font_set_scale: *const fn (font: ?*hb_font_t, x_scale: c_int, y_scale: c_int) callconv(.c) void = undefined;
pub var hb_font_get_scale: *const fn (font: ?*hb_font_t, x_scale: [*c]c_int, y_scale: [*c]c_int) callconv(.c) void = undefined;
pub var hb_font_set_ppem: *const fn (font: ?*hb_font_t, x_ppem: c_uint, y_ppem: c_uint) callconv(.c) void = undefined;
pub var hb_font_get_ppem: *const fn (font: ?*hb_font_t, x_ppem: [*c]c_uint, y_ppem: [*c]c_uint) callconv(.c) void = undefined;
pub var hb_font_set_ptem: *const fn (font: ?*hb_font_t, ptem: f32) callconv(.c) void = undefined;
pub var hb_font_get_ptem: *const fn (font: ?*hb_font_t) callconv(.c) f32 = undefined;
pub var hb_font_is_synthetic: *const fn (font: ?*hb_font_t) callconv(.c) hb_bool_t = undefined;
pub var hb_font_set_synthetic_bold: *const fn (font: ?*hb_font_t, x_embolden: f32, y_embolden: f32, in_place: hb_bool_t) callconv(.c) void = undefined;
pub var hb_font_get_synthetic_bold: *const fn (font: ?*hb_font_t, x_embolden: [*c]f32, y_embolden: [*c]f32, in_place: [*c]hb_bool_t) callconv(.c) void = undefined;
pub var hb_font_set_synthetic_slant: *const fn (font: ?*hb_font_t, slant: f32) callconv(.c) void = undefined;
pub var hb_font_get_synthetic_slant: *const fn (font: ?*hb_font_t) callconv(.c) f32 = undefined;
pub var hb_font_set_variations: *const fn (font: ?*hb_font_t, variations: [*c]const hb_variation_t, variations_length: c_uint) callconv(.c) void = undefined;
pub var hb_font_set_variation: *const fn (font: ?*hb_font_t, tag: hb_tag_t, value: f32) callconv(.c) void = undefined;
pub var hb_font_set_var_coords_design: *const fn (font: ?*hb_font_t, coords: [*c]const f32, coords_length: c_uint) callconv(.c) void = undefined;
pub var hb_font_get_var_coords_design: *const fn (font: ?*hb_font_t, length: [*c]c_uint) callconv(.c) [*c]const f32 = undefined;
pub var hb_font_set_var_coords_normalized: *const fn (font: ?*hb_font_t, coords: [*c]const c_int, coords_length: c_uint) callconv(.c) void = undefined;
pub var hb_font_get_var_coords_normalized: *const fn (font: ?*hb_font_t, length: [*c]c_uint) callconv(.c) [*c]const c_int = undefined;
pub var hb_font_set_var_named_instance: *const fn (font: ?*hb_font_t, instance_index: c_uint) callconv(.c) void = undefined;
pub var hb_font_get_var_named_instance: *const fn (font: ?*hb_font_t) callconv(.c) c_uint = undefined;
...
pub var hb_glyph_info_get_glyph_flags: *const fn (info: [*c]const hb_glyph_info_t) callconv(.c) hb_glyph_flags_t = undefined;
...
pub var hb_segment_properties_equal: *const fn (a: [*c]const hb_segment_properties_t, b: [*c]const hb_segment_properties_t) callconv(.c) hb_bool_t = undefined;
pub var hb_segment_properties_hash: *const fn (p: [*c]const hb_segment_properties_t) callconv(.c) c_uint = undefined;
pub var hb_segment_properties_overlay: *const fn (p: [*c]hb_segment_properties_t, src: [*c]const hb_segment_properties_t) callconv(.c) void = undefined;
...
pub var hb_buffer_create: *const fn () callconv(.c) ?*hb_buffer_t = undefined;
pub var hb_buffer_create_similar: *const fn (src: ?*const hb_buffer_t) callconv(.c) ?*hb_buffer_t = undefined;
pub var hb_buffer_reset: *const fn (buffer: ?*hb_buffer_t) callconv(.c) void = undefined;
pub var hb_buffer_get_empty: *const fn () callconv(.c) ?*hb_buffer_t = undefined;
pub var hb_buffer_reference: *const fn (buffer: ?*hb_buffer_t) callconv(.c) ?*hb_buffer_t = undefined;
pub var hb_buffer_destroy: *const fn (buffer: ?*hb_buffer_t) callconv(.c) void = undefined;
pub var hb_buffer_set_user_data: *const fn (buffer: ?*hb_buffer_t, key: [*c]hb_user_data_key_t, data: ?*anyopaque, destroy: hb_destroy_func_t, replace: hb_bool_t) callconv(.c) hb_bool_t = undefined;
pub var hb_buffer_get_user_data: *const fn (buffer: ?*const hb_buffer_t, key: [*c]hb_user_data_key_t) callconv(.c) ?*anyopaque = undefined;
...
pub var hb_buffer_set_content_type: *const fn (buffer: ?*hb_buffer_t, content_type: hb_buffer_content_type_t) callconv(.c) void = undefined;
pub var hb_buffer_get_content_type: *const fn (buffer: ?*const hb_buffer_t) callconv(.c) hb_buffer_content_type_t = undefined;
pub var hb_buffer_set_unicode_funcs: *const fn (buffer: ?*hb_buffer_t, unicode_funcs: ?*hb_unicode_funcs_t) callconv(.c) void = undefined;
pub var hb_buffer_get_unicode_funcs: *const fn (buffer: ?*const hb_buffer_t) callconv(.c) ?*hb_unicode_funcs_t = undefined;
pub var hb_buffer_set_direction: *const fn (buffer: ?*hb_buffer_t, direction: hb_direction_t) callconv(.c) void = undefined;
pub var hb_buffer_get_direction: *const fn (buffer: ?*const hb_buffer_t) callconv(.c) hb_direction_t = undefined;
pub var hb_buffer_set_script: *const fn (buffer: ?*hb_buffer_t, script: hb_script_t) callconv(.c) void = undefined;
pub var hb_buffer_get_script: *const fn (buffer: ?*const hb_buffer_t) callconv(.c) hb_script_t = undefined;
pub var hb_buffer_set_language: *const fn (buffer: ?*hb_buffer_t, language: hb_language_t) callconv(.c) void = undefined;
pub var hb_buffer_get_language: *const fn (buffer: ?*const hb_buffer_t) callconv(.c) hb_language_t = undefined;
pub var hb_buffer_set_segment_properties: *const fn (buffer: ?*hb_buffer_t, props: [*c]const hb_segment_properties_t) callconv(.c) void = undefined;
pub var hb_buffer_get_segment_properties: *const fn (buffer: ?*const hb_buffer_t, props: [*c]hb_segment_properties_t) callconv(.c) void = undefined;
pub var hb_buffer_guess_segment_properties: *const fn (buffer: ?*hb_buffer_t) callconv(.c) void = undefined;
...
pub var hb_buffer_set_flags: *const fn (buffer: ?*hb_buffer_t, flags: hb_buffer_flags_t) callconv(.c) void = undefined;
pub var hb_buffer_get_flags: *const fn (buffer: ?*const hb_buffer_t) callconv(.c) hb_buffer_flags_t = undefined;
...
pub var hb_buffer_set_cluster_level: *const fn (buffer: ?*hb_buffer_t, cluster_level: hb_buffer_cluster_level_t) callconv(.c) void = undefined;
pub var hb_buffer_get_cluster_level: *const fn (buffer: ?*const hb_buffer_t) callconv(.c) hb_buffer_cluster_level_t = undefined;
pub var hb_buffer_set_replacement_codepoint: *const fn (buffer: ?*hb_buffer_t, replacement: hb_codepoint_t) callconv(.c) void = undefined;
pub var hb_buffer_get_replacement_codepoint: *const fn (buffer: ?*const hb_buffer_t) callconv(.c) hb_codepoint_t = undefined;
pub var hb_buffer_set_invisible_glyph: *const fn (buffer: ?*hb_buffer_t, invisible: hb_codepoint_t) callconv(.c) void = undefined;
pub var hb_buffer_get_invisible_glyph: *const fn (buffer: ?*const hb_buffer_t) callconv(.c) hb_codepoint_t = undefined;
pub var hb_buffer_set_not_found_glyph: *const fn (buffer: ?*hb_buffer_t, not_found: hb_codepoint_t) callconv(.c) void = undefined;
pub var hb_buffer_get_not_found_glyph: *const fn (buffer: ?*const hb_buffer_t) callconv(.c) hb_codepoint_t = undefined;
pub var hb_buffer_set_not_found_variation_selector_glyph: *const fn (buffer: ?*hb_buffer_t, not_found_variation_selector: hb_codepoint_t) callconv(.c) void = undefined;
pub var hb_buffer_get_not_found_variation_selector_glyph: *const fn (buffer: ?*const hb_buffer_t) callconv(.c) hb_codepoint_t = undefined;
pub var hb_buffer_set_random_state: *const fn (buffer: ?*hb_buffer_t, state: c_uint) callconv(.c) void = undefined;
pub var hb_buffer_get_random_state: *const fn (buffer: ?*const hb_buffer_t) callconv(.c) c_uint = undefined;
pub var hb_buffer_clear_contents: *const fn (buffer: ?*hb_buffer_t) callconv(.c) void = undefined;
pub var hb_buffer_pre_allocate: *const fn (buffer: ?*hb_buffer_t, size: c_uint) callconv(.c) hb_bool_t = undefined;
pub var hb_buffer_allocation_successful: *const fn (buffer: ?*hb_buffer_t) callconv(.c) hb_bool_t = undefined;
pub var hb_buffer_reverse: *const fn (buffer: ?*hb_buffer_t) callconv(.c) void = undefined;
pub var hb_buffer_reverse_range: *const fn (buffer: ?*hb_buffer_t, start: c_uint, end: c_uint) callconv(.c) void = undefined;
pub var hb_buffer_reverse_clusters: *const fn (buffer: ?*hb_buffer_t) callconv(.c) void = undefined;
pub var hb_buffer_add: *const fn (buffer: ?*hb_buffer_t, codepoint: hb_codepoint_t, cluster: c_uint) callconv(.c) void = undefined;
pub var hb_buffer_add_utf8: *const fn (buffer: ?*hb_buffer_t, text: [*c]const u8, text_length: c_int, item_offset: c_uint, item_length: c_int) callconv(.c) void = undefined;
pub var hb_buffer_add_utf16: *const fn (buffer: ?*hb_buffer_t, text: [*c]const u16, text_length: c_int, item_offset: c_uint, item_length: c_int) callconv(.c) void = undefined;
pub var hb_buffer_add_utf32: *const fn (buffer: ?*hb_buffer_t, text: [*c]const u32, text_length: c_int, item_offset: c_uint, item_length: c_int) callconv(.c) void = undefined;
pub var hb_buffer_add_latin1: *const fn (buffer: ?*hb_buffer_t, text: [*c]const u8, text_length: c_int, item_offset: c_uint, item_length: c_int) callconv(.c) void = undefined;
pub var hb_buffer_add_codepoints: *const fn (buffer: ?*hb_buffer_t, text: [*c]const hb_codepoint_t, text_length: c_int, item_offset: c_uint, item_length: c_int) callconv(.c) void = undefined;
pub var hb_buffer_append: *const fn (buffer: ?*hb_buffer_t, source: ?*const hb_buffer_t, start: c_uint, end: c_uint) callconv(.c) void = undefined;
pub var hb_buffer_set_length: *const fn (buffer: ?*hb_buffer_t, length: c_uint) callconv(.c) hb_bool_t = undefined;
pub var hb_buffer_get_length: *const fn (buffer: ?*const hb_buffer_t) callconv(.c) c_uint = undefined;
pub var hb_buffer_get_glyph_infos: *const fn (buffer: ?*hb_buffer_t, length: [*c]c_uint) callconv(.c) [*c]hb_glyph_info_t = undefined;
pub var hb_buffer_get_glyph_positions: *const fn (buffer: ?*hb_buffer_t, length: [*c]c_uint) callconv(.c) [*c]hb_glyph_position_t = undefined;
pub var hb_buffer_has_positions: *const fn (buffer: ?*hb_buffer_t) callconv(.c) hb_bool_t = undefined;
pub var hb_buffer_normalize_glyphs: *const fn (buffer: ?*hb_buffer_t) callconv(.c) void = undefined;
...
pub var hb_buffer_serialize_format_from_string: *const fn (str: [*c]const u8, len: c_int) callconv(.c) hb_buffer_serialize_format_t = undefined;
pub var hb_buffer_serialize_format_to_string: *const fn (format: hb_buffer_serialize_format_t) callconv(.c) [*c]const u8 = undefined;
pub var hb_buffer_serialize_list_formats: *const fn () callconv(.c) [*c][*c]const u8 = undefined;
pub var hb_buffer_serialize_glyphs: *const fn (buffer: ?*hb_buffer_t, start: c_uint, end: c_uint, buf: [*c]u8, buf_size: c_uint, buf_consumed: [*c]c_uint, font: ?*hb_font_t, format: hb_buffer_serialize_format_t, flags: hb_buffer_serialize_flags_t) callconv(.c) c_uint = undefined;
pub var hb_buffer_serialize_unicode: *const fn (buffer: ?*hb_buffer_t, start: c_uint, end: c_uint, buf: [*c]u8, buf_size: c_uint, buf_consumed: [*c]c_uint, format: hb_buffer_serialize_format_t, flags: hb_buffer_serialize_flags_t) callconv(.c) c_uint = undefined;
pub var hb_buffer_serialize: *const fn (buffer: ?*hb_buffer_t, start: c_uint, end: c_uint, buf: [*c]u8, buf_size: c_uint, buf_consumed: [*c]c_uint, font: ?*hb_font_t, format: hb_buffer_serialize_format_t, flags: hb_buffer_serialize_flags_t) callconv(.c) c_uint = undefined;
pub var hb_buffer_deserialize_glyphs: *const fn (buffer: ?*hb_buffer_t, buf: [*c]const u8, buf_len: c_int, end_ptr: [*c][*c]const u8, font: ?*hb_font_t, format: hb_buffer_serialize_format_t) callconv(.c) hb_bool_t = undefined;
pub var hb_buffer_deserialize_unicode: *const fn (buffer: ?*hb_buffer_t, buf: [*c]const u8, buf_len: c_int, end_ptr: [*c][*c]const u8, format: hb_buffer_serialize_format_t) callconv(.c) hb_bool_t = undefined;
...
pub var hb_buffer_diff: *const fn (buffer: ?*hb_buffer_t, reference: ?*hb_buffer_t, dottedcircle_glyph: hb_codepoint_t, position_fuzz: c_uint) callconv(.c) hb_buffer_diff_flags_t = undefined;
...
pub var hb_buffer_set_message_func: *const fn (buffer: ?*hb_buffer_t, func: hb_buffer_message_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_buffer_changed: *const fn (buffer: ?*hb_buffer_t) callconv(.c) void = undefined;
...
pub var hb_font_funcs_set_glyph_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_glyph_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
...
pub var hb_unicode_funcs_set_eastasian_width_func: *const fn (ufuncs: ?*hb_unicode_funcs_t, func: hb_unicode_eastasian_width_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_unicode_eastasian_width: *const fn (ufuncs: ?*hb_unicode_funcs_t, unicode: hb_codepoint_t) callconv(.c) c_uint = undefined;
...
pub var hb_unicode_funcs_set_decompose_compatibility_func: *const fn (ufuncs: ?*hb_unicode_funcs_t, func: hb_unicode_decompose_compatibility_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_unicode_decompose_compatibility: *const fn (ufuncs: ?*hb_unicode_funcs_t, u: hb_codepoint_t, decomposed: [*c]hb_codepoint_t) callconv(.c) c_uint = undefined;
pub const hb_font_get_glyph_v_kerning_func_t = hb_font_get_glyph_kerning_func_t;
pub var hb_font_funcs_set_glyph_v_kerning_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_glyph_v_kerning_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_get_glyph_v_kerning: *const fn (font: ?*hb_font_t, top_glyph: hb_codepoint_t, bottom_glyph: hb_codepoint_t) callconv(.c) hb_position_t = undefined;
...
pub var hb_font_funcs_set_glyph_shape_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_get_glyph_shape_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_draw_glyph_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_draw_glyph_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_funcs_set_paint_glyph_func: *const fn (ffuncs: ?*hb_font_funcs_t, func: hb_font_paint_glyph_func_t, user_data: ?*anyopaque, destroy: hb_destroy_func_t) callconv(.c) void = undefined;
pub var hb_font_get_glyph_shape: *const fn (font: ?*hb_font_t, glyph: hb_codepoint_t, dfuncs: ?*hb_draw_funcs_t, draw_data: ?*anyopaque) callconv(.c) void = undefined;
pub var hb_shape: *const fn (font: ?*hb_font_t, buffer: ?*hb_buffer_t, features: [*c]const hb_feature_t, num_features: c_uint) callconv(.c) void = undefined;
pub var hb_shape_full: *const fn (font: ?*hb_font_t, buffer: ?*hb_buffer_t, features: [*c]const hb_feature_t, num_features: c_uint, shaper_list: [*c]const [*c]const u8) callconv(.c) hb_bool_t = undefined;
pub var hb_shape_list_shapers: *const fn () callconv(.c) [*c][*c]const u8 = undefined;
...
pub var hb_shape_plan_create: *const fn (face: ?*hb_face_t, props: [*c]const hb_segment_properties_t, user_features: [*c]const hb_feature_t, num_user_features: c_uint, shaper_list: [*c]const [*c]const u8) callconv(.c) ?*hb_shape_plan_t = undefined;
pub var hb_shape_plan_create_cached: *const fn (face: ?*hb_face_t, props: [*c]const hb_segment_properties_t, user_features: [*c]const hb_feature_t, num_user_features: c_uint, shaper_list: [*c]const [*c]const u8) callconv(.c) ?*hb_shape_plan_t = undefined;
pub var hb_shape_plan_create2: *const fn (face: ?*hb_face_t, props: [*c]const hb_segment_properties_t, user_features: [*c]const hb_feature_t, num_user_features: c_uint, coords: [*c]const c_int, num_coords: c_uint, shaper_list: [*c]const [*c]const u8) callconv(.c) ?*hb_shape_plan_t = undefined;
pub var hb_shape_plan_create_cached2: *const fn (face: ?*hb_face_t, props: [*c]const hb_segment_properties_t, user_features: [*c]const hb_feature_t, num_user_features: c_uint, coords: [*c]const c_int, num_coords: c_uint, shaper_list: [*c]const [*c]const u8) callconv(.c) ?*hb_shape_plan_t = undefined;
pub var hb_shape_plan_get_empty: *const fn () callconv(.c) ?*hb_shape_plan_t = undefined;
pub var hb_shape_plan_reference: *const fn (shape_plan: ?*hb_shape_plan_t) callconv(.c) ?*hb_shape_plan_t = undefined;
pub var hb_shape_plan_destroy: *const fn (shape_plan: ?*hb_shape_plan_t) callconv(.c) void = undefined;
pub var hb_shape_plan_set_user_data: *const fn (shape_plan: ?*hb_shape_plan_t, key: [*c]hb_user_data_key_t, data: ?*anyopaque, destroy: hb_destroy_func_t, replace: hb_bool_t) callconv(.c) hb_bool_t = undefined;
pub var hb_shape_plan_get_user_data: *const fn (shape_plan: ?*const hb_shape_plan_t, key: [*c]hb_user_data_key_t) callconv(.c) ?*anyopaque = undefined;
pub var hb_shape_plan_execute: *const fn (shape_plan: ?*hb_shape_plan_t, font: ?*hb_font_t, buffer: ?*hb_buffer_t, features: [*c]const hb_feature_t, num_features: c_uint) callconv(.c) hb_bool_t = undefined;
pub var hb_shape_plan_get_shaper: *const fn (shape_plan: ?*hb_shape_plan_t) callconv(.c) [*c]const u8 = undefined;
...
pub var hb_style_get_value: *const fn (font: ?*hb_font_t, style_tag: hb_style_tag_t) callconv(.c) f32 = undefined;
pub var hb_version: *const fn (major: [*c]c_uint, minor: [*c]c_uint, micro: [*c]c_uint) callconv(.c) void = undefined;
pub var hb_version_string: *const fn () callconv(.c) [*c]const u8 = undefined;
pub var hb_version_atleast: *const fn (major: c_uint, minor: c_uint, micro: c_uint) callconv(.c) hb_bool_t = undefined;
...
pub var hb_ft_face_create: *const fn (ft_face: FT_Face, destroy: hb_destroy_func_t) callconv(.c) ?*hb_face_t = undefined;
pub var hb_ft_face_create_cached: *const fn (ft_face: FT_Face) callconv(.c) ?*hb_face_t = undefined;
pub var hb_ft_face_create_referenced: *const fn (ft_face: FT_Face) callconv(.c) ?*hb_face_t = undefined;
pub var hb_ft_face_create_from_file_or_fail: *const fn (file_name: [*c]const u8, index: c_uint) callconv(.c) ?*hb_face_t = undefined;
pub var hb_ft_face_create_from_blob_or_fail: *const fn (blob: ?*hb_blob_t, index: c_uint) callconv(.c) ?*hb_face_t = undefined;
pub var hb_ft_font_create: *const fn (ft_face: FT_Face, destroy: hb_destroy_func_t) callconv(.c) ?*hb_font_t = undefined;
pub var hb_ft_font_create_referenced: *const fn (ft_face: FT_Face) callconv(.c) ?*hb_font_t = undefined;
pub var hb_ft_font_get_ft_face: *const fn (font: ?*hb_font_t) callconv(.c) FT_Face = undefined;
pub var hb_ft_font_lock_face: *const fn (font: ?*hb_font_t) callconv(.c) FT_Face = undefined;
pub var hb_ft_font_unlock_face: *const fn (font: ?*hb_font_t) callconv(.c) void = undefined;
pub var hb_ft_font_set_load_flags: *const fn (font: ?*hb_font_t, load_flags: c_int) callconv(.c) void = undefined;
pub var hb_ft_font_get_load_flags: *const fn (font: ?*hb_font_t) callconv(.c) c_int = undefined;
pub var hb_ft_font_changed: *const fn (font: ?*hb_font_t) callconv(.c) void = undefined;
pub var hb_ft_hb_font_changed: *const fn (font: ?*hb_font_t) callconv(.c) hb_bool_t = undefined;
pub var hb_ft_font_set_funcs: *const fn (font: ?*hb_font_t) callconv(.c) void = undefined;
pub var hb_ft_font_get_face: *const fn (font: ?*hb_font_t) callconv(.c) FT_Face = undefined;
...
pub const HB_DEPRECATED = @compileError("unable to translate macro: undefined identifier `__deprecated__`"); // /usr/include/harfbuzz/hb-common.h:71:9
pub const HB_DEPRECATED_FOR = @compileError("unable to translate macro: undefined identifier `__deprecated__`"); // /usr/include/harfbuzz/hb-common.h:79:9
...
pub const HB_BUFFER_CLUSTER_LEVEL_IS_MONOTONE = @compileError("unable to translate macro: undefined identifier `bool`"); // /usr/include/harfbuzz/hb-buffer.h:478:9
pub const HB_BUFFER_CLUSTER_LEVEL_IS_GRAPHEMES = @compileError("unable to translate macro: undefined identifier `bool`"); // /usr/include/harfbuzz/hb-buffer.h:492:9
pub const HB_BUFFER_CLUSTER_LEVEL_IS_CHARACTERS = @compileError("unable to translate macro: undefined identifier `bool`"); // /usr/include/harfbuzz/hb-buffer.h:506:9
...
pub const HB_AAT_LAYOUT_FEATURE_TYPE_CURISVE_CONNECTION = @compileError("unable to translate macro: undefined identifier `HB_AAT_LAYOUT_FEATURE_TYPE_CURSIVE_CONNECTION`"); // /usr/include/harfbuzz/hb-deprecated.h:389:9
pub const HB_SHAPE_H = "";
pub const HB_SHAPE_PLAN_H = "";
pub const HB_STYLE_H = "";
pub const HB_VERSION_H = "";
pub const HB_VERSION_MAJOR = @as(c_int, 14);
pub const HB_VERSION_MINOR = @as(c_int, 1);
pub const HB_VERSION_MICRO = @as(c_int, 0);
pub const HB_VERSION_STRING = "14.1.0";
